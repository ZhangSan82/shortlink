...
public interface LinkDeviceStatsMapper extends BaseMapper<LinkDeviceStatsDO> {
    ...
    @Select("SELECT " +
            ...
            "    t_link_device_stats tlds ON tl.full_short_url COLLATE utf8mb4_general_ci = tlds.full_short_url COLLATE utf8mb4_general_ci " +
            "WHERE " +
            "    tlds.full_short_url COLLATE utf8mb4_general_ci = #{param.fullShortUrl} " +
