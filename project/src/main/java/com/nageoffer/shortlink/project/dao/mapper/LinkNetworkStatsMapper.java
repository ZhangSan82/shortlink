...
public interface LinkNetworkStatsMapper extends BaseMapper<LinkNetworkStatsDO> {
    ...
    @Select("SELECT " +
            ...
            "    t_link_network_stats tlns ON tl.full_short_url COLLATE utf8mb4_general_ci = tlns.full_short_url COLLATE utf8mb4_general_ci " +
            "WHERE " +
            "    tlns.full_short_url COLLATE utf8mb4_general_ci = #{param.fullShortUrl} " +
