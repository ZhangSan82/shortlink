...
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO> {
    ...
    @Insert("INSERT INTO t_link_access_stats (full_short_url, gid, date, pv, uv, uip, hour, weekday, create_time, update_time, del_flag) " +
            ...
            "uip = uip + #{linkAccessStats.uip},update_time = NOW();")
    ...
    @Select("SELECT " +
            ...
            "    t_link_access_stats tlas ON tl.full_short_url COLLATE utf8mb4_general_ci = tlas.full_short_url COLLATE utf8mb4_general_ci " +
            "WHERE " +
            "    tlas.full_short_url COLLATE utf8mb4_general_ci = #{param.fullShortUrl} " +
