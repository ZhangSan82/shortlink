...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO>
{
    ...
    @Select("SELECT " +
            ...
            "    t_link_browser_stats tlbs ON tl.full_short_url COLLATE utf8mb4_general_ci = tlbs.full_short_url COLLATE utf8mb4_general_ci " +
            "WHERE " +
            "    tlbs.full_short_url COLLATE utf8mb4_general_ci = #{param.fullShortUrl} " +
