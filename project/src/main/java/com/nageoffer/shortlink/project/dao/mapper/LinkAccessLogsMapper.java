...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
    ...
    @Select("SELECT " +
            ...
            "    t_link_access_logs tlal ON tl.full_short_url COLLATE utf8mb4_general_ci = tlal.full_short_url COLLATE utf8mb4_general_ci " +
            "WHERE " +
            "    tlal.full_short_url COLLATE utf8mb4_general_ci = #{param.fullShortUrl} " +
